...
const counterObject = (Array) => {
  //console.log(Array)
    let obj = {};
    Array.forEach((el) => {
    if(obj[el]){ //get more clarification why it worked
      obj[el] += 1; //counts if the element exist
    }else {
      obj[el] = 1; //inti a new key
    }
    })
    return obj;
//console.log(obj);
