...
const stringsOnly = (items) => {
  let toString = items.map((items) => {
    if (typeof items !== typeof 'blue white fucking dragon'){
     return ''
    } else {
        return items
    }
