...
//const evenArray2  = arr => arr.map(el => el%2 === 0) // ** Don't use forEach to solve
//console.log(evenArray2([1,2,3,4,5]))
//evenArray2([1,2,3,4,5])
...
console.log(sameArr([1,1,1,2,1])) //** Set first = arr[0], solve differently
...
const tripleTrue = arr => arr.every(el => (el * 3) < 20)
console.log(tripleTrue([1,2,4,7]))
